...
DEVA_SOURCES=deva.cpp scope.cpp semantics.cpp util.cpp error.cpp compile.cpp executor.cpp object.cpp api.cpp builtins.cpp vector_builtins.cpp builtins_helpers.cpp map_builtins.cpp
