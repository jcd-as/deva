...
devaParser.c devaLexer.c devaLexer.h devaParser.h deva.tokens : deva.g
	java -cp "/home/jcs/bin/antlrworks-1.4.2.jar" org.antlr.Tool -message-format gnu deva.g
...
semantic_walker.c semantic_walker.h semantic_walker.tokens : semantic_walker.g deva.tokens
	java -cp "/home/jcs/bin/antlrworks-1.4.2.jar" org.antlr.Tool -message-format gnu semantic_walker.g
...
compile_walker.c compile_walker.h compile_walker.tokens : compile_walker.g deva.tokens
	java -cp "/home/jcs/bin/antlrworks-1.4.2.jar" org.antlr.Tool -message-format gnu compile_walker.g
