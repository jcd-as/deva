...
DEVA_SOURCES=deva.cpp symbol.cpp fileformat.cpp error_report_parsers.cpp scope.cpp executor.cpp instructions.cpp parser_ids.cpp dobject.cpp builtins.cpp compile.cpp semantics.cpp
